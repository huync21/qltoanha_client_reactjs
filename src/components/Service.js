...
const Service = () =>{
    ...
    const editClick = (index) => {
        ...
        document.getElementById('is-required').value = services[index].isRequired;
            ...
            <div className="form-post">
                ...
                <div className="form-post__content">
                    <div className="form-post__wrapper">
                        ...
                        <div className="form-post__field">
                            <input style={{width: '100%'}} type="text" id='is-required' placeholder = "Is required?"/>
                        </div>
                        <div className="form-post__field">
                            <input style={{width: '100%'}} type="text" id='price' placeholder = "Price"/>
                        </div>
                        <div className="form-post__field">
                            <input style={{width: '100%'}} type="text" id='type' placeholder = "Type"/>
                        </div>
                    </div>
